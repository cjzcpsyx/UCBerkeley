...
def tests_to_run(forwarder):
    from tests import BasicTest, RandomDropTest, CorruptionTest, DropStartAndEnd, DupTest, UnorderedACK, WrongSeqno
    BasicTest.BasicTest(forwarder, "README")
    RandomDropTest.RandomDropTest(forwarder, "README")
    CorruptionTest.CorruptionTest(forwarder, "README")
    DropStartAndEnd.DropStartAndEnd(forwarder, "README")
    DupTest.DupTest(forwarder, "README")
    UnorderedACK.UnorderedACK(forwarder, "README")
    WrongSeqno.WrongSeqno(forwarder, "README")
